    ...
    <div className="  rounded-md flex flex-col gap-4 ">
      <div className="flex justify-between items-center mb-4">
        ...
        >
          ...
          {isEditing ? <p className="cust-trans animate-fade-up">إلغاء</p> :<span className="cust-trans animate-fade-up">تعديل</span>}
        </button>
      </div>
      ...
      {isEditing ? (
        <div className=" flex flex-col gap-2 items-end">
          <Textarea
            ...
            rows={4}
          />
          <button aria-label="save" className="mt-2 py-2 text-white px-4 cust-trans w-fit rounded-md bg-primary-dark text-sm hover:bg-primary" onClick={handleSave}>
            حفظ
          </button>
        </div>
      ) : (
